...
/**
 * Created by Andrii_Pashnov on 25.12.2014 21:17.
 */
@WebServlet("/getMaterial")
public class GetMaterialServlet extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(GetMaterialServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        byte[] photo = materialService.getFile(id);
